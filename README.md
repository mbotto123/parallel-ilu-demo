...
Once you have compiled the code successfully and are on a compute node, set the desired number of OpenMP threads with `export OMP_NUM_THREADS = ...` and run the executable `pilu`. Timings will be displayed on standard output. 
